            ...
            <nav class="bg-white border-b border-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink :href="route('user_settings')" :active="route().current('user_settings')">
                                    User Settings
                                </NavLink>
                            </div>
                        </div>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            <div class="ml-3 relative">
                                <Link :href="route('logout')" method="post"
                                    ...
                                    border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('user_settings')" :active="route().current('user_settings')">
                            User Settings
                        </ResponsiveNavLink>
                    </div>
